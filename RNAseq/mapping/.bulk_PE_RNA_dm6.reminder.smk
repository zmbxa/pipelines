### This snakemake file can process paired-end bulk RNAseq data (mouse) ###
...
rule star_align:
    ...
    shell:
        "STAR --runThreadN 8 "
        "--genomeDir /storage/zhangyanxiaoLab/share/STAR_index/dm6 "
...
rule featureCounts:
    input:
        ...
        gtf="/storage/zhangyanxiaoLab/xiongxiong/Reference/Annotation/dm6.gencode.annotation.gtf"
    output:
...
rule tetranscripts:
    ...
    shell:
        ...
        --GTF /storage/zhangyanxiaoLab/xiongxiong/Reference/Annotation/dm6.gencode.annotation.gtf \
        --TE /storage/zhangyanxiaoLab/niuyuxiao/annotations/gtf/dm6_rmsk.gtf \
        -b {input}  
        '''
